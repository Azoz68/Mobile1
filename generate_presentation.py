...
المحتوى العلمي: د. هناء حسين الأهيمر (Dr. Hana Hossen Elahemer).
"""
...
textbox(s, 1.5, 6.1, 10.333, 0.45,
        [P([("المحتوى العلمي:  ", 13.5, tint(WHITE, 0.1)),
           ...
           align=PP_ALIGN.CENTER)])
add_notes(s, "افتتاحية مقترحة: من أكثر الأسئلة التي تشغل الباحثين اليوم: "
             "هل يمكن استخدام الذكاء الاصطناعي لإيجاد "
             "الفجوة البحثية؟ والجواب: نعم — وهذا ما سنتعلمه معاً. الموضوع من أهم "
...
agenda = [
    ("مفهوم الفجوة البحثية", "التعريف الدقيق والصور الأربع التي تظهر بها الفجوات", FUCHSIA, G_FUCHSIA),
...
textbox(s, x + 0.25, y + 0.12, cw2 - 0.5, 0.66,
...
add_notes(s, "خطة العرض في سبعة محاور تتدرج منطقياً: نبدأ بالمفهوم (ما هي "
             ...
             "العملي: أدوات الذكاء الاصطناعي الثماني وسير العمل الذكي "
             "الموصى به، فاستراتيجيات الباحثين المحترفين وإطار التفكير "
             "النقدي، ونختم بالتمييز بين الفجوة القوية والضعيفة وقالب صياغة "
             "جاهز للاستخدام. الهدف: أن يخرج كل طالب وباحث "
...
add_notes(s, "ماذا نقصد بالفجوة البحثية؟ ببساطة: منطقة أو "
             ...
             "(4) اختلاف السياق الجغرافي — ومثالها "
             "الواضح: الدراسة التي تنجح في دولة معينة ليس شرطاً أن تنجح بنفس "
...
add_notes(s, "لماذا الفجوات البحثية مهمة جداً في البحث العلمي؟ "
             "(1) تعطيك Research Direction — اتجاهاً واضحاً لبحثك. "
...
def type_card(slide, x, y, w, h, idx, data):
    ...
    textbox(slide, x + 0.22, y + 2.15, w - 0.44, 1.75,
            [P([("توضيح:  ", 12, ac, True), (detail, 12, INK)],
               align=PP_ALIGN.RIGHT, line=1.15)])
...
add_notes(s, "الأنواع الثلاثة الأولى: (1) فجوة المعرفة "
...
for i, (tag, ex, why_g, ac, gr) in enumerate(examples):
    ...
    textbox(s, M + 0.3, y + 0.44, CW - 2.05, 0.3,
            [P([("لماذا هي فجوة؟  ", 10.5, ac, True), (why_g, 10.5, MUTED)],
               align=PP_ALIGN.RIGHT)])
add_notes(s, "أمثلة عملية: في فجوة المعرفة — تأثير "
             ...
             "الدراسات قبل 2020 لا تعكس تغيرات ما بعد الجائحة. وفي "
             "فجوة الأدلة: التوصية الشائعة بالتعلم المصغّر دون تجارب مضبوطة. "
...
tools = [
    ...
    ("Research Rabbit", "🐇", "يرسم خريطة للعلاقات بين الأبحاث ويكشف مواضع الفراغ", ORANGE, G_AMBER, True),
...
textbox(s, M + 0.3, 6.23, CW - 0.6, 0.4,
        [P([("💡 نصيحة: ", 12.5, AMBER, True),
            ("الأدوات كثيرة، والأقوى Research Rabbit لأنه يرسم خريطة واضحة للعلاقات بين الأبحاث — وسير العمل معه في الشريحة التالية",
             12, WHITE)], align=PP_ALIGN.CENTER)])
add_notes(s, "مع تطور التكنولوجيا صارت لدينا أدوات ذكاء اصطناعي قوية تساعد "
             "الباحث على اكتشاف الفجوات بسرعة. بالترتيب: "
             ...
             "والأقوى بينها Research Rabbit لقدرته على "
             "رسم خريطة واضحة للعلاقات — والشريحة التالية تعرض سير العمل "
...
textbox(s, M, 1.68, CW, 0.4,
        [P([("الطريقة العملية لاستخراج الفجوة البحثية بالذكاء الاصطناعي — أربع خطوات:",
             13.5, MUTED, True)], align=PP_ALIGN.RIGHT)])
flow = [
    ("ارفع ملفات الدراسات", "📤",
...
add_notes(s, "الباحثون المحترفون لديهم استراتيجيات ذكية لاكتشاف الفجوات، "
             "وأهمها: (1) قراءة خاتمة الدراسات (Conclusion "
             ...
             "وهنا غالباً نجد فجوة بحثية ممتازة.")
...
textbox(s, M + 0.3, 6.36, CW - 0.6, 0.38,
        [P([("«التفكير النقدي لا يعني أن ننتقد الدراسات السابقة — بل أن نبني عليها ونطوّرها»",
             13, FUCHSIA, True)], align=PP_ALIGN.CENTER)])
add_notes(s, "أي باحث ناجح لا بد أن يستخدم التفكير النقدي، وهناك إطار "
             ...
             "فجوات قابلة للبحث. وقاعدة مهمة: التفكير النقدي "
...
add_notes(s, "ليست كل فجوة تعتبر قوية. الفجوة القوية "
             ...
             "المقارن يوضح الفرق تماماً: قولنا «الصحة النفسية لم "
...
add_notes(s, "خارطة طريق تنفيذية تجمع كل ما سبق في مسار عملي واحد من سبع "
             ...
             "الخاتمات وأقسام حدود الدراسة — فهي منجم "
...
add_notes(s, "المرحلة الأخيرة: تحويل الملاحظة إلى فجوة علمية مصاغة "
             ...
             "يوضح كيفية ملء العناصر الأربعة بمحتوى حقيقي. وقبل الاعتماد "
...
textbox(s, 1.5, 6.92, 10.333, 0.4,
        [P([("شكراً لحسن استماعكم — ", 12, tint(WHITE, 0.15)),
           ...
           align=PP_ALIGN.CENTER)])
add_notes(s, "الخلاصة: الفجوة البحثية "
             ...
             "وقابلة للمعالجة. والرسالة الأجمل: الباحث "
...
core.author = "Dr. Hana Hossen Elahemer"
core.subject = "دليل شامل لاكتشاف الفجوات البحثية"
core.comments = ""
